<template>
  <v-card class="rounded-card pa-4 pl-6 secondary--text" height="100%">

    <v-card-title class="font-weight-bold px-0">Case Overview</v-card-title>
    <v-container fluid>
        <v-row>
            <v-col>
                <div>
