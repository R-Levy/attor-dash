<template>
    <v-card>
        <v-card-title class="my-2 display-1 secondary--text font-weight-medium">Filter</v-card-title>
        ...
        <v-container>
            ...
            <v-btn rounded color="accent" dark class="px-8" depressed @click="submit">apply filter</v-btn>
            </v-card-actions>
    </v-card>
